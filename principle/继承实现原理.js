...
//给子类型的原型添加方法
Student1.prototype.setSex = function (sex) {
    this.sex = sex;
};
var s = new Student1("张三",20,"男");
console.log(s);
s.setSex("女");
s.setName("李四");
console.log(s.name,s.age,s.sex);// 李四 20 女
console.log(s instanceof Person1);// true
console.log(s instanceof Student1);// true
console.log(s.__proto__ == Student1.prototype);// true
console.log(s.__proto__.__proto__ == Person1.prototype);// true
